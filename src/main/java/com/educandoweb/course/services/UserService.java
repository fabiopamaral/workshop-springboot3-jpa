...
public class UserService {
    ...
    public User findById(Long id) {
        ...
        return obj.orElseThrow(() -> new ResourceNotFoundException(id)); //Tenta dar o get. Se não conseguir lança a exceção
    }
    ...
    public User update(Long id, User obj) {
        User entity = repository.getReferenceById(id); //Somente prepara o objeto monitorado
    ...
    private void updateData(User entity, User obj) {
        ...
        entity.setPhone(obj.getPassword());
    }
}
